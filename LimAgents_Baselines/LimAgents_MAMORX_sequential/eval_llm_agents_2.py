...
df['mistral_limitations_list'] = df['leader_merger_limitations'].apply(parse_merged_limitations)
...
print("avg cosine sim",avg_cosine_sim) 

avg_jaccard_sim = df["avg_jaccard_sim"].mean()
print('avg jaccard sim',avg_jaccard_sim)

avg_rougeL = df["avg_rougeL"].mean() 
print("avg rougeL",avg_rougeL) 

avg_bertscore = df["avg_bertscore"].mean()
print("avg bertscore",avg_bertscore) 

n_yes_pairs = df["n_yes_pairs"].mean()
print("avg n yes pairs",n_yes_pairs)    
