...
df['zs_gpt_lim_list'] = df['zs_gpt_lim'].apply(parse_merged_limitations)
...
# # 1. Configuration
# # ==========================================
# io_csv = "/lstr/sahara/datalab-ml/ibrahim/limagents_update/zero_shot/mistral/output/df_gpt_eval.csv"
...
# ==========================================
io_csv = "/lstr/sahara/datalab-ml/ibrahim/limagents_update/zero_shot/gpt_40_mini/df_gpt_eval_100_199.csv"
col_eval = "llm_evaluation_results"
...
# If you want to include all rows (even those with 0/0 → 0 scores):
avg_cosine_sim = df["avg_cosine_sim"].mean()
avg_jaccard_sim = df["avg_jaccard_sim"].mean()
avg_rougeL = df["avg_rougeL"].mean()

print("\n=== Global Averages (including all rows) ===")
print(f"avg_cosine_sim: {avg_cosine_sim:.4f}")
print(f"Aavg_jaccard_sim:    {avg_jaccard_sim:.4f}")
print(f"avg_rougeL:        {avg_rougeL:.4f}") 
